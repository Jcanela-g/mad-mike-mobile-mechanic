...
const items = [
  { title: 'Brake refresh', note: 'Pads and rotors swapped curbside.' },
  { title: 'Diagnostics', note: 'Tracked a hard start to a bad sensor.' },
  { title: 'Oil + filter', note: 'Clean oil change with disposal included.' },
  { title: 'Tune-up', note: 'Plugs, coils, and a fresh air filter.' },
  { title: 'Battery save', note: 'Emergency jump and terminal clean.' },
  { title: 'Fluid top-off', note: 'Brake and coolant levels checked.' },
];
      ...
      {active && (
        <div className="gallery__modal" role="dialog" aria-modal="true" onClick={() => setActive(null)}>
          <div className="gallery__modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="gallery__modal-image" aria-label={active.title} />
